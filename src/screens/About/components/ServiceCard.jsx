                ...
                >
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            <span className="text-xs font-mono font-bold tracking-[0.2em] text-[#2E5BFF] mb-2 block uppercase">
                                {service.tag}
                            </span>
                            <h3 className="text-3xl font-bold text-white mb-4 uppercase tracking-tight leading-none">
                                {service.title}
                            </h3>
                            <div className="h-1 w-12 bg-white/20" />
                        </div>

                        <div className="flex items-center gap-2 text-white/40 text-sm font-mono uppercase relative z-10">
                    ...
                    >
                        ...
                        <h4 className="text-white text-xl font-bold mb-4 relative z-10">The Pitch</h4>
                        <p className="text-white/90 text-sm leading-relaxed mb-8 relative z-10 font-medium">
                            "{service.pitch}"
                        </p>

                        <div className="mt-auto relative z-10">
                            <h5 className="text-xs font-mono uppercase tracking-widest text-white/60 mb-4 border-b border-white/20 pb-2">
                                Core Offerings
                            </h5>
